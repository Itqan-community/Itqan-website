...
export async function generateMetadata({ params: { locale } }: { params: { locale: Locale } }): Promise<Metadata> {
  ...
  // Use the exact same working image URL for both languages for now
  const workingImageUrl = 'https://opengraph.b-cdn.net/production/images/24f3ccc8-f60a-47ce-a95d-bcc9afdf12e0.png?token=PhACL4wnmnsbd1O7du5h2wtpTICdeSQI0X6flfPqMG0&height=630&width=1200&expires=33286317738';
  ...
  const meta = {
    ...
    url: 'https://itqan.dev', // Use the root domain as in working example
...
<meta name="msapplication-TileColor" content="#669B80" />
        ...
        <meta property="twitter:domain" content="itqan.dev" />
        <meta property="twitter:url" content="https://itqan.dev" />
