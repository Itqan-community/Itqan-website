...
interface EnhancedNewsletterPopupProps {
  locale: string;
}

export default function EnhancedNewsletterPopup({ locale }: EnhancedNewsletterPopupProps) {
          ...
          <div className="p-8">
            {isSuccess ? (
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-green-900 mb-2 font-fustat">
                  {t("successTitle")}
                </h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-red-900 mb-2 font-fustat">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 bg-primary-600 hover:bg-primary-700 disabled:bg-primary-400 disabled:cursor-not-allowed text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200 hover-lift text-sm flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
