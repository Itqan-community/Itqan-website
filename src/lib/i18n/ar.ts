const ar = {
  ...
  home: {
    ...
    impact: {
      ...
      steps: [
        { number: "1", title: "ساهم", body: "اختر مشروعًا قائمًا وساهم فيه بمهاراتك ومراجعاتك وأفكارك" }, // ← ImpactSection.tsx:14-18
        { number: "2", title: "تعلم", body: "استفد من الخبراء لتطور مهاراتك في التقنيات القرآنية" },
        { number: "3", title: "ناقش", body: "انضم إلى مجتمع المطورين والباحثين وشارك خبراتك وأسئلتك" },
        { number: "4", title: "أطلق", body: "ابنِ قدرة مشروعك أو أطلق عليها دعم من مجتمع إتقان" },
      ],
    },
    ...
    cta: {
      ...
      title: "ساهم في تطوير البنية التحتية التقنية للقرآن", // ← CtaSection.tsx:70
    ...
    launch: {
      ...
      steps: [
        { number: "1", title: "ابدأ من أساس جاهز", body: "بيانات ومكتبات قرآنية موثوقة تختصر شهور البحث والإعداد، فتتفرغ لما يميز مشروعك" }, // ← LaunchSection.tsx:12-15
        { number: "2", title: "تجاوز العقبات مع من سبقك إليها", body: "مجتمع تقني يُساندك في التحديات البرمجية ويفتح لك آفاق الشراكة مع مشاريع قرآنية أخرى" },
        { number: "3", title: "اجعل مشروعك مرئيًا", body: "نُبرز مشروعك ونسوق له عبر قنوات إتقان، لا يبقى إنجازك حبيس مستودعك" },
        { number: "4", title: "ابنِ ما لا يتكرر", body: "ندعمك في صقل فكرتك بما يحفظ أصالتها ويخدم استدامة مشروعك بعد الإطلاق" },
      ],
    },
    ...
    launchMobile: {
      ...
      steps: [
        { number: "1", title: "ابدأ من أساس جاهز", body: "مكتبات بيانات قرآنية موثوقة ومصاحف رقمية جاهزة تختصر عليك شهور العمل الشاق لتتفرغ للمميزات." }, // ← LaunchSectionMobile.tsx:13-16
        { number: "2", title: "تجاوز العقبات البرمجية", body: "استشر الخبراء واستعن بمجتمع تقني مكرس لحل التحديات الفنية الصعبة وضبط النظم." },
        { number: "3", title: "اجعل مشروعك مرئيًا", body: "انشر مخرجاتك وسوق لتطبيقك عبر منصات وقنوات إتقان الرسمية للوصول لأكبر فئة مستهدفة." },
        { number: "4", title: "ابنِ ما لا يتكرر", body: "ندعمك في صقل فكرتك بما يضمن أصالة الفكرة واستدامة التطبيق وموثوقية مرجعيته العلمية." },
      ],
    },
